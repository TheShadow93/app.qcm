...
public class Interface7 extends JFrame {
	...
	public Interface7() {
		...
		JLabel lblQuestionQuel = new JLabel("6) Quelle est la capitale de la Nouvelle-Zelande ?");
		lblQuestionQuel.setForeground(Color.BLUE);
		lblQuestionQuel.setBounds(19, 25, 550, 33);
		contentPane.add(lblQuestionQuel);
		
		JButton btnNewButton = new JButton("Auckland");
		...
		JButton btnNewButton_1 = new JButton("Sydney");
		...
		JButton btnNewButton_2 = new JButton("Wellington");
